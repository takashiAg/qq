window.addEventListener("load", function () {
    ...
    var categories = [
        ...
        {category: "ケアマネージャー", color: {background: "#71DEA3"}, img_source: "/img/category/icon_care_manager.png"},
        ...
        {category: "介護器具", color: {background: "#7182DE"}, img_source: "/img/category/icon_device.png"},
        {category: "介護疲れ・ストレス", color: {background: "#8771DE"}, img_source: "/img/category/icon_stress.png"},
        {category: "入浴・排泄ケア", color: {background: "#CF71DE"}, img_source: "/img/category/icon_stress.png"},
